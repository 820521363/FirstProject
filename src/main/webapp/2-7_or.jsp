	  ...
	  <table width="880" border="0" cellspacing="3" cellpadding="5" align="center">
        ...
        <tr> 
          <td height="12" colspan="3"><font size="5"><b> 
            ...
            ARN
            <input type="radio" class="DocType"   name="DocType" id="DocType" value="6" style = "width: 25px; height: 25px;" <%if (DocType!=null && ChkStrEq(DocType,"OWP")) {out.println("checked");}%> onClick="EnableTextbox(1)">
            OWP </b></font></td>
        </tr>
        <tr> 
