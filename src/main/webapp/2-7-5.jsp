      ...
      <table width="100%" border="0">
        <tr> 
          <td><b><font size="3">Login &gt;&gt; Operation Selection &gt;&gt; TQW 
            ...
            by Tag Number<font color="#666666"></font></b></td>
          <td width="100" bgcolor="#FFFF99"> 
            <div align="center"><b>TQW026</b></div>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td colspan="6"><b><font size="6"><br>
      ...
      <table width="700" border="1" cellspacing="0" cellpadding="5" align="center" bordercolor="#000000">
        ...
        <tr> 
          ...
          <td width="201"><font size="5">De-activated (form filling)</font></td>
        </tr>
      </table>
      <p align="center">&nbsp;</p>
      <p align="center"><button class="button button1"  onclick="window.location.href='2-2-1.jsp'"><b>Reprint 
        the Tag</b></button></p>
		 <br>
